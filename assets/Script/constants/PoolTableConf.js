...
const cushions = [
  { shape: 'box', width: hw, height: hh, x: hx, y: hy, tag: CUSHION, dir: 'h' },
  { shape: 'circle', radius: hr, x: hx - hw * 0.5, y: hy, tag: CUSHION },
  { shape: 'circle', radius: hr, x: hx + hw * 0.5, y: hy, tag: CUSHION },
  ...
  { shape: 'box', width: vw, height: vh, x: vx, y: vy, tag: CUSHION, dir: 'v' },
  { shape: 'circle', radius: vr, x: vx, y: vy + vh * 0.5, tag: CUSHION },
  { shape: 'circle', radius: vr, x: vx, y: vy - vh * 0.5, tag: CUSHION },
